...
import com.cx.cache.redis.assist.Config_SingleJedisCache;
import com.cx.cache.redis.assist.JedisCacheHelper;
...
/**
 * 单server端redis客户端，项目中new一次后 全局使用
 * 
 * 
 */
public class SingleServerJedisCache {
	private final Logger logger = LoggerFactory
			.getLogger(SingleServerJedisCache.class);
	 ...
	 * @throws Exception
	 */
	public SingleServerJedisCache() throws Exception {
	 ...
	 * @throws Exception
	 */
	public SingleServerJedisCache(Config_SingleJedisCache config)
			throws Exception {
	...
	private void returnResource(Jedis jedis) {
		try {
			...
			logger.error("SingleServerJedisCache.returnResource falid", e);
		}
	}
	...
	private void returnBrokenResource(Jedis jedis) {
		try {
			...
			logger.error("SingleServerJedisCache.returnBrokenResource falid", e);
		}
	}
	...
	public void destroy() {
		try {
			...
			logger.error("SingleServerSingleServerJedisCache.destroy falid", e);
		}
	}
	...
	public long del(String key) {
		...
		try {
			...
			returnBrokenResource(jedis);
			logger.error("SingleServerJedisCache.del falid", e);
		}
		return result;
	}
	...
	public Set<String> keys(String pattern) {
		...
		try {
			...
			returnBrokenResource(jedis);
			logger.error("SingleServerJedisCache.keys falid", e);
		}
		return result;
	}
