...
/**
 * 分布式redis客户端，项目中new一次后 全局使用
 * 
 * 
 */
public class JedisCache {
	private final Logger logger = LoggerFactory.getLogger(JedisCache.class);
	 ...
	 * @throws Exception
	 */
	public JedisCache() throws Exception {
		ShardedJedisPool shardedJedisPool = JedisCacheHelper
				.initShardedJedisPool(new Config_JedisCache());
	 ...
	 * @throws Exception
	 */
	public JedisCache(Config_JedisCache config) throws Exception {
		ShardedJedisPool shardedJedisPool = JedisCacheHelper
